...
namespace Proyecto_Integrador_3.Populadores
{
    class UsuariosPopulator
    {
        private List<Usuario> _usuarios = new List<Usuario>();
        //private dsUsuarios.UsuariosDataTable UsuariosQueryResult = new dsUsuarios.UsuariosDataTable();
        private dsUsuarios mdsUsuarios = new dsUsuarios();
        
        private SqlCeConnection conn;
        //private UsuarioDBManager mUsuarioDBManager;
        //private UsuariosTableAdapter mUsuariosTableAdapter = new UsuariosTableAdapter();
        //private TableAdapterManager mTableAdapterManager = new TableAdapterManager();
        ...
        public UsuariosPopulator(SqlCeConnection conn)
        {
            this.conn = conn;
            //mUsuarioDBManager = new UsuarioDBManager();
        ...
        public void generarLista()
        {
            ...
            //mUsuariosTableAdapter.ClearBeforeFill = true;
            //mUsuariosTableAdapter.Fill(UsuariosQueryResult);
            
            
            //MessageBox.Show(mdsUsuarios.Usuarios.Rows.Count.ToString());
            foreach (UsuariosRow Row in mdsUsuarios.Usuarios.Rows)
            {
